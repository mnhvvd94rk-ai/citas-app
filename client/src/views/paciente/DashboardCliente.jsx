        ...
        {cargando ? (
          ...
          <>
            ...
            <section className="mt-5 overflow-hidden rounded-2xl bg-gradient-to-br from-navy-700 to-navy-800 p-6 text-white shadow-lg shadow-navy-900/20">
              <p className="text-xs font-semibold uppercase tracking-[0.15em] text-coral-400">{t('clientDash.yourNextAppt')}</p>
              {proxima ? (
                (() => {
              ...
              <section className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                ...
                {medico ? (
                  <div className="flex flex-col items-center text-center">
                    <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-navy-700 text-2xl font-bold text-coral-400">
                    ...
                    {medico.correo && (
                      <a href={`mailto:${medico.correo}`} className="mt-2 break-all text-sm text-navy-600 hover:text-coral-600">
                        {medico.correo}
                      </a>
                    )}
                  </div>
