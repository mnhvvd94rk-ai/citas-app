...
const MESSAGES = {
  ES: {
    ...
    'error.anuncioNoEncontrado': 'Anuncio no encontrado',
    'error.enlaceNoEncontrado': 'Enlace de registro no encontrado',
    'error.enlaceInactivo': 'Este enlace ya no está activo. Contacta a tu profesional para obtener su enlace de registro actual.',
  ...
  EN: {
    ...
    'error.anuncioNoEncontrado': 'Announcement not found',
    'error.enlaceNoEncontrado': 'Registration link not found',
    'error.enlaceInactivo': 'This link is no longer active. Contact your professional to get their current registration link.',
  ...
  FR: {
    ...
    'error.anuncioNoEncontrado': 'Annonce introuvable',
    'error.enlaceNoEncontrado': "Lien d'inscription introuvable",
    'error.enlaceInactivo': "Ce lien n'est plus actif. Contactez votre professionnel pour obtenir son lien d'inscription actuel.",
